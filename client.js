...
jw_utils.getToken = function() {return '4C13E962-8BE4-1516-19BE-F78D8414C076'; }; 
var jw_md5 = {};
...
tbView.tname=tname;
	...
	tbView.loadjscssfile('jw_0','//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js','js',
	  ...
	  if(tver=='0') {
			...
			tbView.loadjscssfile('jw_ad_4',host+'/tlb/v4/jw_ad.js','js');
	  }else{ 
		...
		if (typeof jw_jquery != 'undefined' && jw_jquery != null) {
			if(	document.getElementById('jw_5') && document.getElementById('bar_4') && document.getElementById('bar_3') && 
				...
				if(typeof jwBarInterface != 'undefined'){ 
					jwBarInterface.token='4C13E962-8BE4-1516-19BE-F78D8414C076';
...
tbView.start_search = function(index){
		...
		window.setTimeout(function(){
			...
			if(_jw_search.urls && _jw_search.urls.length>0) 
			{
				...
				var u='//api.jollywallet.com/affiliate/search?dist='+_jw_search.dist+'&sub='+_jw_search.dist_sub+'&p=0&token=4C13E962-8BE4-1516-19BE-F78D8414C076&ver=0&ref='+index+'&r='+Math.random()+'&ulist='+encodeURIComponent(JSON.stringify(_jw_search.urls));
			 	jw_jquery.ajax({
					url: u,
					type: 'GET',
					crossDomain: true,
	...
	if(search_index>0){
		...
		if(search_index==6) setInterval(_jw_search.g_search, 350);	} 
			...
			var e='';if(r != null) e='&docref='+r;
 			var _aqs = '';
 			if(typeof(Storage) === 'undefined'){}
 			else {_aqs = sessionStorage.getItem('rym_content');if(_aqs===null) _aqs='';}
			tbView.loadjscssfile('jw_a','//query.jollywallet.com/affiliate/jsquery2?dist=336&sub=cay&ver=1&p=0&token=4C13E962-8BE4-1516-19BE-F78D8414C076&aff_ref='+aff_ref+e+'&r='+Math.random()+'&width='+window.screen.width+'&height='+window.screen.height+_aqs,'js',null);
	} 
};
